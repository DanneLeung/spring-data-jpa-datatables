...
@EnableJpaRepositories(repositoryFactoryBeanClass = DataTablesRepositoryFactoryBean.class, basePackages = {
		"org.springframework.data.jpa.datatables.model", "org.springframework.data.jpa.datatables.repository" })
public class Config {
	...
	@Bean
	public AbstractEntityManagerFactoryBean entityManager(DataSource dataSource) throws SQLException {
